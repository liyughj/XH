...
└────────────────────┬────────────────────────────────────────┘
        ...
        ▼            ▼            ▼                ▼
┌──────────────┐ ┌──────────────┐ ┌──────────────┐ ┌──────────────┐ ┌──────────────┐
│ Enchanting   │ │ Bookshelf    │ │ Enchanting   │ │ Enchanting   │ │ Config       │
│ Table        │ │ Listener     │ │ Level        │ │ Item         │ │ Manager      │
│ Listener     │ │              │ │ Listener     │ │ Listener     │ │              │
│              │ │ 监听书架放置   │ │              │ │              │ │ 管理配置项    │
│ 监听附魔台交互 │ │ 和破坏事件    │ │ 监听附魔完成   │ │ 监听物品放入   │ │              │
...
| `EnchantingItemListener` | **新增**：监听物品放入附魔台事件，限制只有普通书可附魔 |
...
| `PrepareItemEnchantEvent` | `HIGH` | **新增**：在附魔选项显示前判断物品类型 |
