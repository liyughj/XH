...
public enum RpgAttribute {
    ...
    /** 射速（RPM 每分钟发数），如 600=10发/秒，射击间隔=60000/RPM ms */
    ...
    /** 故障冷却（tick），一次故障后再次检测的最小间隔 */
    GUN_MALFUNC_COOLDOWN_TICKS("gun_malfunc_cooldown_ticks", "故障冷却", ValueType.FLAT, 0.0, Double.MAX_VALUE, 20.0, Category.GUN),
    GUN_MALFUNC_TYPE_WEIGHTS("gun_malfunc_type_weights", "故障类型权重", ValueType.FLAT, 0.0, 1000.0, 8020010.0, Category.GUN), // 编码: jam*1000000+misfire*1000+cata
    ...
    /** 子弹重力等级：0=直线(hitscan) 1=弱重力 2=标准重力 */
